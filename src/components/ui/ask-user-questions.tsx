            ...
            <span className="inline-grid w-full">
              <textarea
                ...
                className={cn(
                  ...
                  "im-textarea col-start-1 row-start-1 block w-full bg-transparent border-0 p-0 m-0 outline-none resize-none overflow-hidden leading-snug text-foreground placeholder:text-muted-foreground",
                  sizeClasses.text
                )}
              ...
              {isFreeText ? (
                ...
                <div
                  ...
                  className={cn(
                    ...
                    // overlay the selected option rows use — but the focus ring
                    // stays regardless, so it doesn't vanish the moment you
                    // start typing while still actively editing the field.
                    otherText.length > 0
                      ? "bg-active focus-within:ring-1 focus-within:ring-inset focus-within:ring-border"
                  ...
                  <Field.Control
                    ...
                    render={
                      <textarea
                        ...
                        className={cn(
                          "im-textarea block w-full bg-transparent border-0 p-0 m-0 outline-none resize-none overflow-hidden leading-snug text-foreground placeholder:text-muted-foreground",
                          sizeClasses.text
                        )}
                        style={{ fontVariationSettings: fontWeights.medium }}
                      />
